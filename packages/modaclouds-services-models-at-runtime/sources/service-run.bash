...
_variable_overrides=(
		...
		_LOAD_BALANCER_CONTROLLER_ENDPOINT_IP="${MODACLOUDS_LOAD_BALANCER_CONTROLLER_ENDPOINT_IP:-${_LOAD_BALANCER_CONTROLLER_ENDPOINT_IP}}"
		_LOAD_BALANCER_CONTROLLER_ENDPOINT_PORT="${MODACLOUDS_LOAD_BALANCER_CONTROLLER_ENDPOINT_PORT:-${_LOAD_BALANCER_CONTROLLER_ENDPOINT_PORT}}"

		_MONITORING_MANAGER_ENDPOINT_IP="${MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_IP:-${_MONITORING_MANAGER_ENDPOINT_IP}}"
		_MONITORING_MANAGER_ENDPOINT_PORT="${MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_PORT:-${_MONITORING_MANAGER_ENDPOINT_PORT}}"

		_TOWER4CLOUDS_MANAGER_PUBLIC_ENDPOINT_PORT="${MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_PORT_PUBLIC}"
		_TOWER4CLOUDS_MANAGER_PUBLIC_ENDPOINT_IP="${MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_IP_PUBLIC}"
...
if [ -z $_TOWER4CLOUDS_MANAGER_PUBLIC_ENDPOINT_PORT ]; then
        printf '[ee] MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_PORT_PUBLIC env var not defined; \n' >&2
fi

if [ -z $_TOWER4CLOUDS_MANAGER_PUBLIC_ENDPOINT_IP ]; then
		printf '[ee] MODACLOUDS_TTOWER4CLOUDS_MANAGER_ENDPOINT_PORT_PUBLIC env var not defined; \n' >&2
fi
...
_environment+=(
		MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_IP="${_MONITORING_MANAGER_ENDPOINT_IP}"
		MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_PORT="${_MONITORING_MANAGER_ENDPOINT_PORT}"
		...
		MODACLOUDS_LOAD_BALANCER_CONTROLLER_ENDPOINT_IP="${_LOAD_BALANCER_CONTROLLER_ENDPOINT_IP}"
		MODACLOUDS_LOAD_BALANCER_CONTROLLER_ENDPOINT_PORT="${_LOAD_BALANCER_CONTROLLER_ENDPOINT_PORT}"
